...
const FluidCursor = () => {
  ...
  useEffect(() => {
    ...
    function correctRadius(radius) {
      // Simplified radius correction - no aspect ratio scaling for now
      return radius;
    }

    function splat(x, y, dx, dy, color) {
      // Debug: log splat coordinates
      console.log('Splat at:', x, y);
    ...
    function updatePointerMoveData(pointer, posX, posY, color) {
      ...
      console.log('Normalized:', pointer.texcoordX, pointer.texcoordY);
    ...
    const handleMouseMove = (e) => {
      ...
      console.log('Mouse:', e.clientX, e.clientY, 'Canvas:', canvas.width, canvas.height);
